...
class ProductModelTemplatesController extends AdminController
{
    ...
    protected function addProductModelForm($form)
    {
        ...
        // $form->add('price', trans('labels.price'), 'text')
        ...
        //            ->options(
        //                $form->model->catalogAttribute($attr->value)->options->pluck('id', 'name')
        //            );
        //    }
        //}
        //else {
            ...
            if ($form->action == 'delete') {
                ...
                if (
                    ...
                    $image = File::create([
                        ...
                        'type' => File::TYPE_MODEL_IMAGE_BACK
                    ]);
                    if ($image) {
                ...
                // overlay_back
                    if (
                        ...
                        $overlayBackFile = File::create([
                            ...
                            'type' => File::TYPE_MODEL_OVERLAY_BACK
                        ]);
                        if ($overlayBackFile) {
